...
import { Color, Geometry, Mesh, Program, Text, Texture } from "ogl-typescript"

import fragment from '../src/shaders/text-fragment.glsl'
import vertex from '../src/shaders/text-vertex.glsl'
...
export default class {
  ...
  createShader () {
    ...
    console.log("[debug] this.renderer", this.renderer)
